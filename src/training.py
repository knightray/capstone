...
def main(_):
	...
	if ttype == define.TYPE_NORMAL:
		train_images_list, train_labels_list, test_images_list, test_labels_list = data_processing.get_train_data_from_museum_dataset(data_dir)	
		...
		train_images_list, train_labels_list, verify_images_list, verify_labels_list = data_processing.get_train_data_from_museum_dataset(data_dir)	
		test_images_list = data_processing.get_test_data_from_museum_dataset(define.DATA_DIR)
